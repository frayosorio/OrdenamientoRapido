...
public class FrmOrdenamiento extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnOrdenar.setToolTipText("Ortdenar");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Nombre - Documento", "Documento - Nombre" }));
        jComboBox1.setToolTipText("Secuencia de Ordenamiento");
    ...
    private void btnOrdenarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrdenarActionPerformed
        txtTiempo.setText(Documento.ordenarBurbuja());
        Documento.mostrarLista(tblDatos);
